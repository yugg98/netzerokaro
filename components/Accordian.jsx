...
function Accordian() {
    return (
        <div>
            <Disclosure className="bg-white p-4 my-10" defaultOpen>
                {({ open }) => (
                    /* Use the `open` state to conditionally change the direction of an icon. */
                    <div className='my-10 rounded-lg'>
                        <Disclosure.Button className='flex bg-white p-4 '>
                        ...
                        >
                            <Disclosure.Panel className={'p-6 pl-16 pt-0 bg-white rounded-lg text-black'}>
